import { firebaseInit, AnalyticEvent , analyticEvent } from '@beitissieshapiro/issie-shared';
import { debugToken } from './debug-token';
import { NativeModules, Platform } from 'react-native';
export { analyticEvent, categorizeColor, categorizeCount, categorizeDuration, categorizeSize } from '@beitissieshapiro/issie-shared'
