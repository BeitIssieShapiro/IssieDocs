...
export const languageMap = {
  he: {
    ...
    BeforeDeleteSubPageMenu: 'מחיקת עמוד זה ({1} מתוך {2})',
    ...
    TemplatePageFormTitle: 'יצירה מתבנית',
    ...
    KeyboardTextTools: 'כלי טקסט במקלדת',
    SpeakAndDictate: 'דיבור והכתבה',
    SpeakDictateFloating: 'צף',
    SpeakDictateToolbar: 'סרגל כלים',
    SpeechRate: 'מהירות דיבור',
    LowVolumeWarning: 'עוצמת הקול נמוכה מאוד',
    ...
    BtnAddPage: 'דף נוסף',
    BtnSave: 'שמירה',
    ShareMenuTitle: "שיתוף",
    BtnShareAsPDF: 'שיתוף כקובץ PDF',
    BtnShareIssieDocs: 'שיתוף כדף עבודה',
    BtnShareAsImages: 'שיתוף כתמונה',
    BtnChangeName: 'שינוי שם',
    BtnDelete: 'מחיקה',
    BtnDuplicate: 'שיכפול',
    BtnSaveAsTemplate: 'שמור כתבנית',
    BtnEditTemplate: 'עריכת תבנית',
    BtnMove: 'העברה',
    BtnUndoAll: 'מחק כל השינויים בעמוד זה',
    BtnLockChanges: 'איפוס ביטול',
    BtnUnlockChanges: 'שחרור איפוס',
    ...
    FeedbackTitlePlaceholder: "תיאור קצר של המשוב",
    ...
    DictationFailedTitle: 'הכתבה נכשלה',
    DictationLangNotSupported: 'הכתבה אינה זמינה בשפת המקלדת הנוכחית במכשיר זה. נסו לעבור לשפה אחרת.',
    DictationRecognizerUnavailable: 'שירות ההכתבה אינו זמין כרגע. בדקו את חיבור האינטרנט ונסו שוב.',
    DictationNoSpeech: 'לא זוהה דיבור. אנא דברו ברור ונסו שוב.',
    DictationNetworkRequired: 'הכתבה בשפה זו דורשת חיבור אינטרנט.',
    DictationRecognitionFailed: 'ההכתבה נכשלה. אנא נסו שוב.',
    DictationMicNotReady: 'המיקרופון לא מוכן. סגרו אפליקציות שמע אחרות ונסו שוב.',
    DictationAudioSessionError: 'לא ניתן להפעיל את השמע. סגרו אפליקציות שמע אחרות ונסו שוב.',
    DictationEngineError: 'לא ניתן להפעיל את המיקרופון.',
    DictationMicPermissionDenied: 'נדחתה הרשאת מיקרופון. ללא הרשאה זו, ההכתבה אינה זמינה.',
    DictationSpeechPermissionDenied: 'נדחתה הרשאה לזיהוי דיבור. ללא הרשאה זו, ההכתבה אינה זמינה.',
    DictationSpeechRestricted: 'זיהוי דיבור מוגבל במכשיר זה.',
    DictationPermissionNotDetermined: 'הרשאת זיהוי דיבור עדיין לא ניתנה. ללא הרשאה זו, ההכתבה אינה זמינה.',
  },
  ar: {
    ...
    TemplatePageFormTitle: 'إنشاء من قالب',
    ...
    KeyboardToolbar: 'شريط أدوات لوحة المفاتيح',
    TextTools: 'أدوات النص',
    KeyboardTextTools: 'أدوات النص في لوحة المفاتيح',
    SpeakAndDictate: 'التحدث والإملاء',
    SpeakDictateFloating: 'عائم',
    SpeakDictateToolbar: 'شريط الأدوات',
    SpeechRate: 'سرعة الكلام',
    LowVolumeWarning: 'مستوى الصوت منخفض جدًا',
    ...
    BtnDelete: 'حذف',
    BtnDuplicate: 'تكرير',
    BtnSaveAsTemplate: 'حفظ كقالب',
    BtnEditTemplate: 'تحرير القالب',
    BtnMove: 'يتحرك', //todo check
    BtnUndoAll: 'حذف جميع التغييرات في هذه الصفحة',
    BtnLockChanges: 'إعادة تعيين التراجع',
    BtnUnlockChanges: 'إلغاء إعادة التعيين',
    ShareMenuTitle: "قائمة المشاركة",
    BtnShareAsPDF: 'مشاركة كملف PDF',
    BtnShareAsImages: 'مشاركة كصورة',
    BtnShareIssieDocs: 'مشاركة كورقة عمل',
    ...
    DictationFailedTitle: 'فشل الإملاء',
    DictationLangNotSupported: 'الإملاء غير متاح للغة لوحة المفاتيح الحالية على هذا الجهاز. جرّب لغة أخرى.',
    DictationRecognizerUnavailable: 'خدمة الإملاء غير متاحة حالياً. تحقق من اتصال الإنترنت وحاول مرة أخرى.',
    DictationNoSpeech: 'لم يتم اكتشاف كلام. يرجى التحدث بوضوح والمحاولة مرة أخرى.',
    DictationNetworkRequired: 'تتطلب الإملاء بهذه اللغة اتصالاً بالإنترنت.',
    DictationRecognitionFailed: 'فشل الإملاء. يرجى المحاولة مرة أخرى.',
    DictationMicNotReady: 'الميكروفون غير جاهز. أغلق تطبيقات الصوت الأخرى وحاول مرة أخرى.',
    DictationAudioSessionError: 'تعذر بدء الصوت. أغلق تطبيقات الصوت الأخرى وحاول مرة أخرى.',
    DictationEngineError: 'تعذر تشغيل الميكروفون.',
    DictationMicPermissionDenied: 'تم رفض إذن الميكروفون. بدون هذا الإذن، الإملاء غير متاح.',
    DictationSpeechPermissionDenied: 'تم رفض إذن التعرف على الكلام. بدون هذا الإذن، الإملاء غير متاح.',
    DictationSpeechRestricted: 'التعرف على الكلام مقيد على هذا الجهاز.',
    DictationPermissionNotDetermined: 'لم يتم منح إذن التعرف على الكلام بعد. بدون هذا الإذن، الإملاء غير متاح.',
  },
  en: {
    ...
    BeforeDeleteSubPageMenu: 'Delete This Page ({1} of {2})',
    ...
    TemplatePageFormTitle: 'New from Template',
    ...
    KeyboardTextTools: 'Keyboard Text Tools',
    SpeakAndDictate: 'Speak and Dictate',
    SpeakDictateFloating: 'Floating',
    SpeakDictateToolbar: 'Toolbar',
    SpeechRate: 'Speech Rate',
    LowVolumeWarning: 'Volume is very low',
    ...
    BtnShareAsPDF: 'Share as PDF',
    BtnShareAsImages: 'Share as Image',
    ...
    BtnMove: 'Move',
    BtnUndoAll: 'Delete All Changes In This Page',
    BtnLockChanges: 'Reset Undo',
    BtnUnlockChanges: 'Unlock Reset',
    ...
    FeedbackTitlePlaceholder: "Short title",
    FeedbackPlaceholder: 
    ...
    DictationFailedTitle: 'Dictation Failed',
    DictationLangNotSupported: 'Dictation is not available for the current keyboard language on this device. Try a different language.',
    DictationRecognizerUnavailable: 'Dictation service is currently unavailable. Check your internet connection and try again.',
    DictationNoSpeech: 'No speech detected. Please speak clearly and try again.',
    DictationNetworkRequired: 'Dictation in this language requires an internet connection.',
    DictationRecognitionFailed: 'Dictation failed. Please try again.',
    DictationMicNotReady: 'Microphone is not ready. Please close other audio apps and try again.',
    DictationAudioSessionError: 'Could not start audio. Please close other audio apps and try again.',
    DictationEngineError: 'Could not start the microphone.',
    DictationMicPermissionDenied: 'Microphone permission was not granted. Without it, dictation is not available.',
    DictationSpeechPermissionDenied: 'Speech recognition permission was not granted. Without it, dictation is not available.',
    DictationSpeechRestricted: 'Speech recognition is restricted on this device.',
    DictationPermissionNotDetermined: 'Speech recognition permission has not been granted yet. Without it, dictation is not available.',
  },
};
