...
export function getSvgIcon(name, size, color, strokeWidth) {
    ...
    switch (name) {
        ...
        case 'doodle':
            return <Svg viewBox="0 0 45 42" {...props} >
        ...
        case 'start-icon':
            ...
            // </Svg>
            return <Svg width="100px" height="137px" viewBox="0 0 100 137">
                <G id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                    <G id="10.5”-iPad-Air-folders-3ADD-folders/pages-with-arrow" transform="translate(-111.000000, -206.000000)" stroke="#27A7E0" strokeWidth="4">
        ...
        case 'new-camera':
            return <Svg {...props} viewBox="0 0 35 32">
                <G stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <G transform="translate(-31.000000, -85.000000)" fill="#1AAEFF">
        ...
        case 'eraser-new':
            return <Svg {...props} viewBox="0 0 900 940" >
                <G>
                    <G>
                        <Polygon fill="#002237" points="466.8,585.4 466.4,720.7 284.8,615.8 285.1,480.5 		" />
                        <G>
                            <G enableBackground="new    ">
                                <G>
                                    <Polygon fill="#818282" points="314.6,675.8 314.3,794.8 146.8,698.1 147.2,579.1 					" />
                                </G>
                                <G>
                                    <Polygon fill="#BABBBB" points="314.6,675.8 457.7,592.6 457.3,711.6 314.3,794.8 					" />
                                </G>
                                <G>
                                    <Polygon fill="#D0D1D1" points="147.2,579.1 290.2,496 457.7,592.6 314.6,675.8 					" />
                                </G>
                            </G>
                        </G>
                        <Polygon fill="#00314F" points="466.8,585.4 775.5,406 775.1,541.3 466.4,720.7 		" />
                        <Polygon fill="#003658" points="285.1,480.5 593.8,301.1 775.5,406 466.8,585.4 		" />
                    </G>
                    <G>
                        <G>
                            <Path fill="#FFFFFF" d="M475.6,481.3l33.2,3.3l-7.4,4.3c-1.5,0.8-3.1,1.1-4.9,0.9l-29.1-3.1c-1-0.1-1.9-0.1-2.6,0
				c-0.7,0.1-1.6,0.5-2.5,1l-4.6,2.7l20.5,11.9l-8.3,4.8L419,477.5l15.1-8.7c3.4-1.9,6.6-3.4,9.7-4.4c3.1-1,6.1-1.6,8.9-1.8
				c2.8-0.2,5.5,0,8,0.6s4.9,1.5,7,2.8c1.8,1,3.1,2.1,4.1,3.3c1,1.2,1.6,2.5,1.9,3.8c0.2,1.3,0.1,2.7-0.5,4
				c-0.6,1.4-1.5,2.8-2.9,4.1C472,481.1,473.8,481.1,475.6,481.3z M458.2,483.1c1.9-1.1,3.3-2.2,4.3-3.3c1-1.1,1.5-2.1,1.6-3.2
				c0.1-1-0.1-2-0.8-2.9c-0.7-0.9-1.7-1.8-3.1-2.6c-2.8-1.6-5.8-2.3-9.1-2.1c-3.3,0.2-6.8,1.4-10.6,3.6l-6.8,3.9l17.9,10.4
				L458.2,483.1"/>
                        </G>
                        <G>
                            <Path fill="#FFFFFF" d="M526.8,414.7c2.9-1.7,6.1-3,9.5-3.9c3.4-0.9,6.8-1.3,10.3-1.4l1.9,3.5c0.2,0.4,0.2,0.7,0.1,1
				c-0.1,0.3-0.3,0.5-0.8,0.8c-0.5,0.3-1.1,0.4-2.1,0.5c-0.9,0.1-2,0.3-3.3,0.5c-1.3,0.2-2.7,0.5-4.2,0.9c-1.5,0.4-3,1.1-4.6,2
				c-1.4,0.8-2.5,1.6-3.2,2.5c-0.7,0.8-1.1,1.6-1.2,2.4c-0.1,0.8,0.1,1.5,0.6,2.3c0.5,0.7,1.2,1.4,2.3,2c1.3,0.8,2.7,1.2,4.3,1.3
				c1.5,0.1,3.2,0,4.9-0.3c1.7-0.3,3.6-0.7,5.5-1.3c1.9-0.6,3.9-1.1,5.9-1.7c2-0.6,4.1-1.1,6.2-1.5c2.1-0.5,4.2-0.7,6.4-0.8
				c2.1-0.1,4.3,0.1,6.4,0.6c2.1,0.5,4.3,1.3,6.4,2.5c2.3,1.3,4,2.8,5.2,4.4c1.2,1.6,1.8,3.3,1.8,5c0,1.7-0.7,3.4-2,5.2
				c-1.3,1.7-3.4,3.4-6.1,5c-1.6,0.9-3.4,1.8-5.3,2.5c-1.9,0.7-3.8,1.3-5.8,1.8c-2,0.5-4,0.8-6.1,1.1c-2.1,0.2-4.1,0.3-6.1,0.3
				l-1.5-3.7c-0.1-0.3-0.1-0.6,0-0.9c0.1-0.3,0.4-0.6,0.8-0.8c0.5-0.3,1.4-0.5,2.6-0.6c1.2-0.1,2.5-0.2,4.1-0.4
				c1.5-0.2,3.2-0.5,5.1-1c1.8-0.5,3.7-1.2,5.5-2.3c3-1.7,4.6-3.5,4.8-5.3c0.2-1.8-1-3.4-3.6-4.9c-1.4-0.8-3-1.3-4.6-1.4
				c-1.6-0.1-3.3,0-5,0.2c-1.7,0.3-3.5,0.7-5.4,1.3c-1.9,0.6-3.8,1.2-5.8,1.8c-2,0.6-4,1.1-6.1,1.6c-2.1,0.5-4.2,0.7-6.4,0.8
				c-2.2,0-4.4-0.2-6.6-0.7c-2.2-0.5-4.5-1.4-6.8-2.8c-1.8-1.1-3.3-2.3-4.2-3.7c-1-1.4-1.5-2.9-1.4-4.5c0.1-1.6,0.7-3.2,1.9-4.8
				C522.2,417.7,524.2,416.2,526.8,414.7z"/>
                        </G>
                        <G>
                            <Path fill="#FFFFFF" d="M486.7,438.5l71.2,17.8l-6.4,3.7c-0.7,0.4-1.5,0.7-2.3,0.7c-0.8,0-1.6,0-2.4-0.2l-15.5-4.1l-22,12.7l7,9
				c0.3,0.4,0.4,0.8,0.3,1.3c-0.1,0.5-0.5,1-1.2,1.4l-6.4,3.7l-30.6-41.3L486.7,438.5z M505.5,464.4l17.5-10.1l-25.6-6.7
				c-2-0.5-4.4-1.2-7.2-2.2c0.8,0.8,1.6,1.6,2.2,2.3c0.6,0.7,1.2,1.4,1.6,1.9L505.5,464.4"/>
                        </G>
                        <G>
                            <Polygon fill="#FFFFFF" points="410,482.8 416.7,486.6 393.1,500.2 408.4,509.1 427.3,498.3 433.7,502 414.9,512.9 430.6,522 
				454.2,508.4 460.8,512.3 428.9,530.7 378.1,501.2 			"/>
                        </G>
                        <G>
                            <Polygon fill="#FFFFFF" points="583.7,382.5 590.4,386.3 566.8,400 582.1,408.9 601,398 607.4,401.7 588.6,412.6 604.3,421.8 
				627.9,408.1 634.5,412 602.6,430.5 551.8,400.9 			"/>
                        </G>
                        <G>
                            <Path fill="#FFFFFF" d="M649.3,381l33.2,3.3l-7.4,4.3c-1.5,0.8-3.1,1.1-4.9,0.9l-29.1-3.1c-1-0.1-1.9-0.1-2.6,0
				c-0.7,0.1-1.6,0.5-2.5,1l-4.6,2.7l20.5,11.9l-8.3,4.8l-50.9-29.6l15.1-8.7c3.4-1.9,6.6-3.4,9.7-4.4c3.1-1,6.1-1.6,8.9-1.8
				c2.8-0.2,5.5,0,8,0.6c2.5,0.6,4.9,1.5,7,2.8c1.8,1,3.1,2.1,4.1,3.3c1,1.2,1.6,2.5,1.9,3.8c0.2,1.3,0.1,2.7-0.5,4
				c-0.6,1.4-1.5,2.8-2.9,4.1C645.7,380.8,647.5,380.8,649.3,381z M631.9,382.8c1.9-1.1,3.3-2.2,4.3-3.3c1-1.1,1.5-2.1,1.6-3.2
				c0.1-1-0.1-2-0.8-2.9c-0.7-0.9-1.7-1.8-3.1-2.6c-2.8-1.6-5.8-2.3-9.1-2.1c-3.3,0.2-6.8,1.4-10.6,3.6l-6.8,3.9l17.9,10.4
				L631.9,382.8"/>
                        </G>
                    </G>
